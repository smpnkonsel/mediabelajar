...
const CHAPTERS = [
    {
        id: "spldv",
        file: "soal/bab-1-spldv.html",
        label: "Sistem Persamaan Linear Dua Variabel",
        icon: "📐"
    },
    {
        id: "lingkaran",
        file: "soal/bab-2-lingkaran.html",
        label: "Lingkaran",
        icon: "⭕"
    },
    {
        id: "bangun-ruang",
        file: "soal/bab-3-bangun-ruang.html",
        label: "Bangun Ruang",
        icon: "📦"
    },
    {
        id: "transformasi-geometri",
        file: "soal/bab-4-transformasi-geometri.html",
        label: "Transformasi Geometri",
        icon: "🔄"
    },
    {
        id: "kekongruenan-kesebangunan",
        file: "soal/bab-5-kekongruenan-kesebangunan.html",
        label: "Kekongruenan & Kesebangunan",
        icon: "🔺"
    },
    {
        id: "teori-peluang",
        file: "soal/bab-6-teori-peluang.html",
        label: "Teori Peluang",
        icon: "🎲"
    }
];
